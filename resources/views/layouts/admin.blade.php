    ...
    <body class="font-sans antialiased" x-data="{ mobileOpen: false }">
        <div class="flex h-screen overflow-hidden bg-slate-50">
            ...
            <aside
                ...
                <div class="flex flex-col gap-0.5 px-5 py-5 border-b border-gray-700/50 shrink-0">
                    <x-oxilaris-logo size="md" variant="dark" />
                    <span class="text-red-400 text-xs font-medium">Admin Panel</span>
                </div>
