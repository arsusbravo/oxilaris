    ...
    <x-slot name="header">
        <div class="flex items-center justify-between gap-3 w-full">
            <div class="flex items-center gap-3 min-w-0">
                <a href="{{ route('products.index', request('back') ? ['store_id' => request('back')] : []) }}"
                   class="text-slate-400 hover:text-slate-600 transition-colors p-1 rounded-md hover:bg-slate-100 shrink-0">
            ...
            <div class="flex items-center gap-2 shrink-0">
                <a href="{{ route('products.edit', $product) }}"
                   class="flex items-center gap-1.5 text-sm text-indigo-600 hover:text-indigo-800 font-medium px-3 py-1.5 border border-indigo-200 rounded-lg hover:bg-indigo-50 transition-colors">
